...
const targetStr = `<div className="bg-blue-900 text-white font-bold px-2 py-1 text-xs print:text-[10px] leading-tight">1. INFORMAÇÕES DO MOTORISTA E VEÍCULO</div>
...
const newStr = `<div className="bg-blue-900 text-white font-bold px-2 py-1 text-xs print:text-[10px] leading-tight">1. INFORMAÇÕES DO {userRole === 'CLIENT' ? 'TRANSPORTADOR' : 'MOTORISTA'} E VEÍCULO</div>
          {userRole === 'CLIENT' ? (
